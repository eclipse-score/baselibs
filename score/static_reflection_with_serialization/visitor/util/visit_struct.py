...
for x in range(N, 0, -1):
    ...
    print("#define SCORE_STRUCT_VISITABLE{}(S, F{}) \\\".format(x, ", F".join(strange)))
    print("    SCORE_STRUCT_VISITABLE_FULL_DEFINITION(S, \\")
    print("    ::score::common::visitor::detail::pack_values(#F{}), s.F{}) \\\".format(", #F".join(strange), ", s.F".join(strange)))
    print("")
...
print("// coverity[autosar_cpp14_a16_0_1_violation]")
print("// coverity[autosar_cpp14_m16_0_6_violation]")
print("#define SCORE_GET_NTH_ARG(_{}, N, ...) N".format(", _".join(strange)))
...
print("// coverity[autosar_cpp14_a16_0_1_violation]")
print("// coverity[autosar_cpp14_m16_0_6_violation]")
print("#define SCORE_COUNT_VARARGS(...) SCORE_GET_NTH_ARG(__VA_ARGS__, {}, 0)".format(", ".join(strange[::-1])))
...
print("// coverity[autosar_cpp14_a16_0_1_violation]")
print("// coverity[autosar_cpp14_m16_0_6_violation]")
print("#define SCORE_CONCATENATE2(A, B) A##B")
...
print("// coverity[autosar_cpp14_a16_0_1_violation]")
print("// coverity[autosar_cpp14_m16_0_6_violation]")
print("#define SCORE_CONCATENATE(A, B) SCORE_CONCATENATE2(A, B)")
print("")
print("// NOLINTNEXTLINE(cppcoreguidelines-macro-usage)")
print("// Macros for Concatenation.")
print("// Macros are used to concatenate names and can't use parenthesis")
print("// coverity[autosar_cpp14_a16_0_1_violation]")
print("// coverity[autosar_cpp14_m16_0_6_violation]")
print("#define SCORE_STRUCT_VISITABLE(S, ...) SCORE_CONCATENATE(SCORE_STRUCT_VISITABLE, SCORE_COUNT_VARARGS(__VA_ARGS__))(S, __VA_ARGS__)")
