...
void print_score_result_memory_layout()
{
    ...
    printf("  score::Result<bool>: %zu bytes, alignment: %zu\n",
           sizeof(score::Result<bool>),
           alignof(score::Result<bool>));
...
// Tests that a Result<int32_t> can be created
bool create_result_int32_error_for_layout_test(int32_t error_code,
                                               score::Result<std::int32_t>* out_result,
                                               std::size_t bufsize)
{
    if (bufsize == sizeof(score::Result<std::int32_t>))
