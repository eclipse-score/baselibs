...
#include "score/flatbuffers/examples/config_usecase/component_config_versioned.h"
...
TEST(DemoConfigVersionedTest, VerifiesVersionThenLoadsAndReadsBuffer)
{
    ...
    // -------------------------------------------------------------------------
    const std::string_view bin_path = "score/flatbuffers/examples/config_usecase/demo_config_versioned.bin";
