...
class AtomicFetchAddTest : public ::testing::Test
{
  public:
    ...
    {
        concurrency::AtomicIndirectorMock<T>::SetMockObject(&atomic_mock_);
        return *this;
    }
    ...
    concurrency::AtomicMock<T> atomic_mock_{};
};
...
TYPED_TEST(AtomicFetchAddTest, WillReTryAtomicAddIfCompareExchangeFails)
{
    ...
    const auto fetch_added_value_result = details::TryAtomicAddImpl<TypeParam, concurrency::AtomicIndirectorMock>(
