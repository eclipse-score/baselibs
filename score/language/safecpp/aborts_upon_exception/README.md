...
- Safety-relevant applications should avoid use of exceptions, further details
  can be found under the [platform assumption of use for no exceptions](https://eclipse-score.github.io/score/main/requirements/platform_assumptions/index.html#aou_req__platform__no_exceptions)
