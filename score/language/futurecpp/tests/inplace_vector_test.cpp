...
/// @testmethods TM_REQUIREMENT
/// @requirement CB-#17893146
TEST(inplace_vector_test, trivial_destructible)
{
    ...
    static_assert(std::is_trivially_destructible_v<score::cpp::inplace_vector<trivial_destructible_only, 2>>);
    static_assert(std::is_trivially_destructible_v<score::cpp::inplace_vector<std::int32_t, 2>>);
}
