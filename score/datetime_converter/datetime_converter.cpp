...
std::shared_ptr<DateTimeType> epochToDateTime(time_t epoch)
{
    ...
    /*moving computation of leapyear outside the loop as year is not chnanging at this point and computing repeatedly in the iteration for same year is of no value add. */ 
