...
class Stdlib : public ObjectSeam<Stdlib>
{
  public:
    ...
    virtual int setenv(const char* const name, const char* const value, int overwrite) const noexcept = 0;
    virtual int unsetenv(const char* const name) const noexcept = 0;
