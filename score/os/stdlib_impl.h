...
class StdlibImpl final : public Stdlib
{
  public:
    ...
    Result<int> setenv(const char* const name, const char* const value, int overwrite) const noexcept override;
    Result<int> unsetenv(const char* const name) const noexcept override;
