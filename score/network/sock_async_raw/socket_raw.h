 ...
 ********************************************************************************/
#ifndef SCORE_LIB_NETWORK_RAW_SOCKET_H
#define SCORE_LIB_NETWORK_RAW_SOCKET_H
...
namespace os
{
class SocketRaw final : public SocketAsync, public std::enable_shared_from_this<SocketRaw>
{
  public:
    SocketRaw(const std::shared_ptr<SocketCtrl> sock_ctrl, const Endpoint endpoint, std::int32_t protocol);
...
#endif  // SCORE_LIB_NETWORK_RAW_SOCKET_H
