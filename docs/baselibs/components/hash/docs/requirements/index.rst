...
.. comp_req:: Hash Value as Hexadecimal String
   :id: comp_req__hash__value_retrieval
   :reqtype: Functional
   :security: NO
   :safety: ASIL_B
   :derived_from: feat_req__baselibs__hash_library
   ...
   The hash library shall expose the computed hash value as a hexadecimal
...
.. comp_req:: Cryptographic Hash Algorithms
   :id: comp_req__hash__openssl_algorithms
   :reqtype: Functional
   :security: NO
   :safety: ASIL_B
   :derived_from: feat_req__baselibs__hash_library
