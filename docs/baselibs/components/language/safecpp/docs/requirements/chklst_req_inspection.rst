...
.. document:: Safecpp Requirements Inspection Checklist
   :id: doc__safecpp_req_inspection
   :status: draft
   :safety: ASIL_B
   :security: YES
...
.. needtable::
   :filter: "safecpp" in docname and "requirements" in docname and docname is not None and status == "valid"
   :style: table
   :types: comp_req
   :tags: safecpp
